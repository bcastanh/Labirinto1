...
public class Maze {
 ...
 private static final String TARGET = "§";
	...
	// creating the maze and target point
	public Maze(int width, int height, int targetX, int targetY, int numberOfBlocks) {
        ...
        // walking into tge waze, getting waze information for taking decision
	public MazeWalkingInfo getInfoForDirections(Direction[] directions) {
		...
		info.setSteps(steps);// how many steps
		info.setStepsToReachTarget(stepsToReachTarget); // how much steps was necessary to target
                int fitnessV = steps/stepsToReachTarget;// fitness following Valerias code
		return info;
